...
public class ICWarsBehavior extends AreaBehavior {
    ...
    public class ICWarsCell extends AreaBehavior.Cell {
        ...
        protected boolean canEnter(Interactable entity) {
            //return false if entity.takeCellSpace() is true and at least one other on this cell is also entity.takeCellSpace() true.
            if (entity.takeCellSpace()) {
                for (Interactable entityInCell : this.entities) { // could be super.entities ?
